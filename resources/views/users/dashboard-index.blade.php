        ...
        <section>
            <div class="grid grid-cols-4 gap-5">
                <div
                    ...
                    <h1 class="text-white text-5xl font-bold w-[20%] -mt-2">{{ $dailyPost }}</h1>
                ...
                <div
                    ...
                    <h1 class="text-white text-5xl font-bold w-[20%] -mt-2">{{ $weeklyPost }}</h1>
                    <p class="w-[80%] flex flex-col text-white font-bold text-xl text-end"><span>WEEKLY</span>NEW POST
                    </p>
                </div>
                <div
                    ...
                    <h1 class="text-white text-5xl font-bold w-[20%] -mt-2">{{ $monthlyPost }}</h1>
                    <p class="w-[80%] flex flex-col text-white font-bold text-xl text-end"><span>MONTHLY</span>NEW POST
                    </p>
                </div>
                <div
                    ...
                    <h1 class="text-white text-5xl font-bold w-[20%] -mt-2">{{ $totalPost }}</h1>
